...
\begin{document}
  ...
  {\remark Determining The Slope of a Linear Equation \stepcounter{tcount}\\
  ...
  {\theorem Equivalent Definition of Slope (optional)  \stepcounter{tcount}
    ...
    Which is simply the ratio between the difference between the $y$ and $x$ co-ordinates of two points on a line. \qed
  }
